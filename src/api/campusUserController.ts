...
export async function getUserById(
  ...
  return request<API.BaseResponseCampusUser>('/user/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function updateUserVo(
  ...
  return request<API.BaseResponseLoginUserVO>('/user/update/vo', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function userRegister(
  ...
  return request<API.BaseResponseLoginUserVO>('/user/register', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
